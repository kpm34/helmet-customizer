          ...
          return (
            ...
            >
              <button
                ...
                className={`
                  relative w-full px-2.5 py-2 rounded-lg text-xs font-medium transition-all duration-200
              ...
              >
                {/* Color indicator */}
                <div
                  className="absolute top-1.5 right-1.5 w-3.5 h-3.5 rounded-full border-2 border-white/20"
                  style={{
