  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-[#676767]">
        ...
        <div className="flex items-center justify-center p-8" style={{ width: '768px', height: '432px' }}>
          <img
            src="/logo.svg"
            alt="Logo"
        ...
        {activeZone === 'shell' && (
          <>
            <button
              ...
              className="flex-1 relative py-2.5 text-center text-sm font-delphi font-semibold transition-all rounded-xl overflow-hidden text-gray-800 hover:text-gray-900 bg-white/20 backdrop-blur-sm border border-white/30"
            >
              {currentStep === 1 && (
                <motion.div
                  className="absolute top-[-450%] left-0 right-0 bottom-0 h-[1000%] rounded-xl opacity-80"
                  style={{
                    background: 'conic-gradient(transparent 200deg, rgba(107, 114, 128, 1))',
                    zIndex: 1,
                  }}
                  initial={{ rotate: 0 }}
                  animate={{ rotate: 360 }}
