...
# Path to your helmet file (update this to your actual helmet location)
# Option 1: Use the base helmet in assets
OBJ_PATH = Path(__file__).parent.parent.parent / "assets" / "hc_helmet_base_v2.blend"
# Option 2: Or specify absolute path to your helmet OBJ
